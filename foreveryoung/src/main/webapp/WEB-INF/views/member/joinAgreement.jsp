...
$(document).ready(function () {
	$("#totalcheck").change(function(){
		...
		$("input[name=agree]").prop("checked", checkval);
	});
	
	
	$("#allagree-form").submit(function(e){
		e.preventDefault();
		
		$("input[name=agree]").each(function(){
			if($("input[name=agree]").is(":checked") != true) {
				alert("이용약관을 모두 동의하셔야 합니다");
				return;
			}
		});
...
<body>
	<form action="/member/join" method="get" id="allagree-form">
        <div class="outbox">
        	<input type="checkbox" id="totalcheck"><label for="totalcheck">전체 선택</label>
            <div class="row">
                <span>이용약관1</span>
                <label>
                    <input id="first" class="agree-check" type="checkbox" name="agree" value="1">
                    동의합니다
                </label>
            </div>
            <div class="row">
                <textarea class="input" rows="5" readonly="readonly">1조(목적) 이 약관은 OO 회사(전자상거래 사업자)가 운영하는 OO 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.
            ...
            <div class="row">
                <span>이용약관2</span>
                <label>
                    <input id="second" class="agree-check" type="checkbox" name="agree" value="2">
                    동의합니다
                </label>
            </div>
            <div class="row">
                <textarea class="input" rows="5" disabled="disabled">1조(목적) 이 약관은 OO 회사(전자상거래 사업자)가 운영하는 OO 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.
            ...
            <div class="row">
                <span>이용약관3</span>
                <label>
                    <input id="third" class="agree-check" type="checkbox" name="agree" value="3">
                    동의합니다
                </label>
            </div>
            <div class="row">
                <textarea class="input" rows="5" disabled>1조(목적) 이 약관은 OO 회사(전자상거래 사업자)가 운영하는 OO 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.
            ...
            <div class="row">
                <input id="next-btn" class="input" type="submit" value="다음 단계로 이동">
            </div>
        </div> 
    </form>
</body>
